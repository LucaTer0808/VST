...
if __name__ == "__main__":
    ...
    # test
    parser.add_argument('--Testing', action="store_true", help='Testing or not')
    parser.add_argument('--rgb', required=True, type=str, help='RGB path for testing')
    parser.add_argument('--depth', required=True, type=str)
    parser.add_argument('--target', required=True, type=str, help='path for saving testing results')

    # evaluation
    parser.add_argument('--Evaluation', action="store_true", help='Evaluation or not')
